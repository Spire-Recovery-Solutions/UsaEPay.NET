...
namespace UsaEPay.NET.Models.Classes
{
    public class UsaEPayRequest : IUsaEPayRequest
    {
        ...
        /// <summary>
        /// Unique identifier for the batch generated by gateway. You can also use current reference the currently open batch
        /// </summary>
        [JsonProperty("batch_key", NullValueHandling = NullValueHandling.Ignore)]
        public string BatchKey { get; set; }
        /// <summary>
        /// Limit setting for this response. Used for pagination. This will default to "20".
        /// </summary>
        [JsonProperty("limit", NullValueHandling = NullValueHandling.Ignore)]
        public int Limit { get; set; }
        /// <summary>
        /// Offset setting for this response. This will default to "0".
        /// </summary>
        [JsonProperty("offset", NullValueHandling = NullValueHandling.Ignore)]
        public int Offset { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are opened before this date.
        /// </summary>
        [JsonProperty("openedlt", NullValueHandling = NullValueHandling.Ignore)]
        public string OpenedLt { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are opened after this date.
        /// </summary>
        [JsonProperty("openedgt", NullValueHandling = NullValueHandling.Ignore)]
        public string OpenedGt { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are closed before this date.
        /// </summary>
        [JsonProperty("closedlt", NullValueHandling = NullValueHandling.Ignore)]
        public string ClosedLt { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are closed after this date.
        /// </summary>
        [JsonProperty("closedgt", NullValueHandling = NullValueHandling.Ignore)]
        public string ClosedGt { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are opened before this date. (Including this date)
        /// </summary>
        [JsonProperty("openedle", NullValueHandling = NullValueHandling.Ignore)]
        public string OpenedLe { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are opened after this date. (Including this date)
        /// </summary>
        [JsonProperty("openedge", NullValueHandling = NullValueHandling.Ignore)]
        public string OpenedGe { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are closed before this date. (Including this date)
        /// </summary>
        [JsonProperty("closedle", NullValueHandling = NullValueHandling.Ignore)]
        public string ClosedLe { get; set; }
        /// <summary>
        /// Format of date should be YYYYmmdd. Will include the results that are closed after this date. (Including this date)
        /// </summary>
        [JsonProperty("closedge", NullValueHandling = NullValueHandling.Ignore)]
        public string ClosedGe { get; set; }
        /// <summary>
